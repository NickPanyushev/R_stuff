...
reg_features <- fread("Annotation_data/reg_features.txt")
miRNA_targets <- fread("Annotation_data/miRNA_targets.txt")
other_regions <- fread("Annotation_data/other_regions.txt")
TF_motifs <- fread("Annotation_data/bind_motifs.txt")
reg_evidence <- fread("Annotation_data/reg_evidence.txt") #Может быть битым
