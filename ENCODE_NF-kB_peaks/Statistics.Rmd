...
```{r}
bin_number_dt <- data.table(bins_regions)
names(bin_number_dt) <- c("Regions")
...
temp_df <- nest(all_bins, Peak_Bins) # NOT WORKING
#CONSIDER importing the raw data and peak binarization instead of doing nest()
