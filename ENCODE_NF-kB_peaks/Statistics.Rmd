...
inter_len <- function(num_vector, mx=intersect_matrix){
...
intersect_vec <- replicate(10, inter_len(sample(1:length(intersect_matrix), 2))) #для 2 линий 
print(intersect_vec)
intersect_vec <- replicate(10, inter_len(sample(1:length(intersect_matrix), 3))) #для 3 линий
print(intersect_vec)
intersect_vec <- replicate(10, inter_len(sample(1:length(intersect_matrix), 3))) #для 4 линий
print(intersect_vec)

#Для 10 сразу уже нули идут
intersect_vec <- replicate(10, inter_len(sample(1:length(intersect_matrix), 10))) #для 10
print(intersect_vec)
