...
generated_df <- lapply(generated_df, function(x) replicate(100, inter_len(sample(1:length(intersect_list), x))))
...
# Запишем в файл
fwrite(generated_df, file = "Script_files/gen_conbinations.tsv")
```
