...
Интересно, почему? 
Видимо, дело либо в клетках, либо в пиках

Теперь посмотрим на summary по пикам
```{r, results="asis", echo=F}

```

Построим для всех этих пиков гистограммку количества пиков от их хромосомы
Этот график надо переделать, не информативен совершенно
